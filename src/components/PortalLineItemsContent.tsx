...
interface PortalLineItemsContentProps {
  darkMode: boolean;
...
export function PortalLineItemsContent({ 
  darkMode, 
  viewMode, 
  onBack 
}: PortalLineItemsContentProps) {
  ...
  const lineItems: LineItem[] = [
    {
      id: "LI-20250910-2ECO",
      name: "HIV/AIDS Awareness Seminar",
    ...
    {
      id: "LI-20250905-WICY",
      name: "Anti-Illegal Drugs Seminar",
      area: "Public and Order",
      category: "PPA",
      budget: "₱55,555.56",
      ...
      <div className="flex-1 bg-white dark:bg-gray-800">
        <div className="p-8">
          ...
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl text-black dark:text-white">Line Items</h2>
                ...
                {filteredLineItems.map((item, index) => (
                  ...
                  >
                    <td className="px-6 py-6">
                      <p className="text-[#4a5565] dark:text-gray-400 text-sm">{item.id}</p>
                    </td>
                    <td className="px-6 py-6">
                      <div className="flex flex-col gap-1">
                        <p className="text-[#101828] dark:text-gray-200">{item.name}</p>
                        <p className="text-sm text-[#4a5565] dark:text-gray-400">
                          <span className="font-semibold">Area of Participation:</span> {item.area}
                        </p>
                      </div>
                    </td>
                    <td className="px-6 py-6">
                      <p className="text-[#101828] dark:text-gray-200">{item.category}</p>
                    </td>
                    <td className="px-6 py-6">
                      <p className="text-[#101828] dark:text-gray-200">{item.budget}</p>
                    </td>
                    <td className="px-6 py-6">
                      <p className="text-[#101828] dark:text-gray-200">{item.implementationDate}</p>
                    </td>
                    <td className="px-6 py-6">

import svgPaths from "./svg-72bp7f4pf1";
...
function Slug() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="slug">
      <p className="font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#606060] text-[22px] text-nowrap">{`/  Portal Management / Line Items`}</p>
    </div>
  );
}
...
function HeaderCell() {
  return (
    <div className="h-[46px] relative shrink-0 w-[233px]" data-name="Header Cell">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[24px] py-[26px] relative size-full">
...
function HeaderCell1() {
  return (
    <div className="h-[46px] relative shrink-0 w-[322px]" data-name="Header Cell">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[24px] py-[26px] relative size-full">
...
function HeaderCell2() {
  return (
    <div className="h-[46px] relative shrink-0 w-[194px]" data-name="Header Cell">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[23px] py-[26px] relative size-full">
...
function HeaderCell3() {
  return (
    <div className="h-[46px] relative shrink-0 w-[199px]" data-name="Header Cell">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[24px] py-[26px] relative size-full">
...
function HeaderCell4() {
  return (
    <div className="content-stretch flex h-[46px] items-center justify-center px-[24px] py-[16px] relative shrink-0 w-[284px]" data-name="Header Cell">
...
function TableRow() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex h-[46px] items-center relative shrink-0 w-full" data-name="Table Row">
      <HeaderCell />
      <HeaderCell1 />
      <HeaderCell2 />
      <HeaderCell3 />
...
function TableCell1() {
  return (
    <div className="content-stretch flex flex-col items-start px-[24px] py-[33px] relative shrink-0 w-[322px]" data-name="Table Cell">
      <Container6 />
    </div>
  );
}
...
function Container7() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-full" data-name="Container">
      <p className="font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[#101828] text-[14px] text-nowrap">₱55,555.56</p>
    </div>
  );
}
...
function TableCell15() {
  return (
    <div className="content-stretch flex flex-col items-start px-[24px] py-[25px] relative shrink-0 w-[322px]" data-name="Table Cell">
      <Container19 />
    </div>
  );
}
...
function TableCell29() {
  return (
    <div className="content-stretch flex flex-col items-start px-[24px] py-[32px] relative shrink-0 w-[322px]" data-name="Table Cell">
      <Container33 />
    </div>
  );
}
...
export default function PortalManagementLineItems() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="PORTAL MANAGEMENT - Line Items">
      <Navbar />
      <BottomOfNav />
    </div>
  );

import svgPaths from "./svg-kq36ufg1c8";
...
function Slug() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="slug">
      <p className="font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#606060] text-[22px] text-nowrap">{`/  Archives`}</p>
    </div>
  );
}
...
function Resolutions() {
  return (
    <div className="[grid-area:1_/_1] content-stretch flex items-center justify-center p-[20px] relative rounded-[14px] self-stretch shrink-0 w-[527.33px]" data-name="resolutions" style={{ backgroundImage: "linear-gradient(162.329deg, rgba(43, 127, 255, 0.35) 0%, rgba(21, 93, 252, 0.35) 100%)" }}>
      <div aria-hidden="true" className="absolute border border-[rgba(96,96,96,0.5)] border-solid inset-0 pointer-events-none rounded-[14px]" />
      <Container6 />
    </div>
  );
...
function Icon10() {
  return (
    <div className="basis-0 grow h-[32px] min-h-px min-w-px relative shrink-0" data-name="Icon">
        ...
        <div className="absolute bottom-1/2 left-[20.83%] right-[20.83%] top-1/2" data-name="Vector">
          <div className="absolute inset-[-1.33px_-7.14%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 3">
              <path d="M1.33333 1.33333H20" id="Vector" stroke="var(--stroke-0, #4A5565)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
            </svg>
          </div>
        </div>
        <div className="absolute bottom-[20.83%] left-1/2 right-1/2 top-[20.83%]" data-name="Vector">
          <div className="absolute inset-[-7.14%_-1.33px]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 3 22">
              <path d="M1.33333 1.33333V20" id="Vector" stroke="var(--stroke-0, #4A5565)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
            </svg>
          </div>
        </div>
      </div>
...
function Container10() {
  return (
    <div className="bg-[#f3f4f6] content-stretch flex items-start pb-0 pt-[12px] px-[12px] relative rounded-[10px] shrink-0 size-[56px]" data-name="Container">
      <Icon10 />
    </div>
  );
}
...
function Heading3() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="Heading 3">
      <p className="font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#101828] text-[16px] text-center text-nowrap">Add Category</p>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="content-stretch flex h-[20px] items-start relative shrink-0 w-[139.609px]" data-name="Paragraph">
      <p className="font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[#4a5565] text-[14px] text-center text-nowrap">Create new archive type</p>
    </div>
  );
}
...
function Container11() {
  return (
    <div className="relative shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[16px] items-center relative">
        <Container10 />
        <Heading3 />
        <Paragraph />
      </div>
...
function Add() {
  return (
    <div className="[grid-area:2_/_2] bg-[rgba(194,194,194,0.35)] h-[168px] justify-self-stretch relative rounded-[14px] shrink-0" data-name="add">
      <div aria-hidden="true" className="absolute border border-[#606060] border-dashed inset-0 pointer-events-none rounded-[14px]" />
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center p-[21px] relative size-full">
          <Container11 />
        </div>
      </div>
    </div>
...
function Archives1() {
  return (
    <div className="gap-[24px] grid grid-cols-[repeat(3,_minmax(0px,_1fr))] grid-rows-[repeat(2,_fit-content(100%))] relative shrink-0 w-full" data-name="Archives">
      <Ordinances />
      <Resolutions />
      <Minutes />
      <Add />
...
function App() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] h-[804px] items-center overflow-clip relative rounded-tl-[16px] shrink-0 w-full" data-name="App">
      <Container />
      <Archives1 />
    </div>
  );
...
export default function Archives2() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="ARCHIVES">
      <Navbar />
      <BottomOfNav />
    </div>
  );

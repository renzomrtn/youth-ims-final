import svgPaths from "./svg-rxir20g2p5";
...
function Slug() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="slug">
      <p className="font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#606060] text-[22px] text-nowrap">{`/  Projects / Projects by Year`}</p>
    </div>
  );
}
...
function Button3() {
  return (
    <div className="relative shrink-0" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center px-[3px] py-px relative">
        <p className="font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#155dfc] text-[16px] text-center text-nowrap">Projects by Year</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[24px] relative shrink-0 w-[138.406px]" data-name="Heading 2">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Source_Sans_3:Bold',sans-serif] font-bold leading-[24px] left-0 text-[#101828] text-[20px] text-nowrap top-0">{`Projects  for 2024`}</p>
      </div>
    </div>
  );
}
...
function HeaderCell2() {
  return (
    <div className="content-stretch flex h-[53px] items-start px-[24px] py-[16px] relative shrink-0 w-[264px]" data-name="Header Cell">
...
function HeaderCell7() {
  return (
    <div className="content-stretch flex h-[52.5px] items-start px-[24px] py-[16px] relative shrink-0 w-[92.328px]" data-name="Header Cell">
...
function TableCell1() {
  return (
    <div className="content-stretch flex items-center px-[24px] py-[36px] relative shrink-0 w-[160px]" data-name="Table Cell">
      <p className="font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#101828] text-[16px] text-nowrap">John Doe</p>
    </div>
  );
}
...
function TableCell2() {
  return (
    <div className="content-stretch flex items-center px-[24px] py-[36px] relative shrink-0 w-[264px]" data-name="Table Cell">
      <p className="font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#101828] text-[16px] text-nowrap">HIV/AIDS Awareness Seminar</p>
    </div>
  );
}
...
function Text1() {
  return (
    <div className="bg-[#f0fdf4] h-[24px] relative rounded-[3.35544e+07px] shrink-0 w-full" data-name="Text">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[12px] py-[4px] relative size-full">
          <Text />
          <p className="font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[16px] relative shrink-0 text-[#00a63e] text-[12px] text-nowrap">Completed</p>
        </div>
      </div>
    </div>
  );
...
function Button6() {
  return <div className="rounded-[10px] shrink-0 size-[32px]" data-name="Button" />;
}

function TableCell7() {
  return (
    <div className="content-stretch flex items-center px-[24px] py-[32px] relative shrink-0" data-name="Table Cell">
      <Button6 />
    </div>
  );
}
...
function TableCell9() {
  return (
    <div className="content-stretch flex items-center px-[24px] py-[36px] relative shrink-0 w-[160px]" data-name="Table Cell">
      <p className="font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#101828] text-[16px] text-nowrap">Maria Garcia</p>
    </div>
  );
}
...
function TableCell17() {
  return (
    <div className="content-stretch flex items-center px-[24px] py-[36px] relative shrink-0 w-[160px]" data-name="Table Cell">
      <p className="font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#101828] text-[16px] text-nowrap">Roberto Santos</p>
    </div>
  );
}
...
function TableCell25() {
  return (
    <div className="content-stretch flex items-center px-[24px] py-[36px] relative shrink-0 w-[160px]" data-name="Table Cell">
      <p className="font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#101828] text-[16px] text-nowrap">Sarah Johnson</p>
    </div>
  );
}
...
function TableCell33() {
  return (
    <div className="content-stretch flex items-center px-[24px] py-[35px] relative shrink-0 w-[160px]" data-name="Table Cell">
      <p className="font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#101828] text-[16px] text-nowrap">Michael Brown</p>
    </div>
  );
}
...
function TableCell34() {
  return (
    <div className="content-stretch flex items-center px-[24px] py-[35px] relative shrink-0 w-[264px]" data-name="Table Cell">
...
function Heading1() {
  return (
    <div className="h-[24px] relative shrink-0 w-[138.406px]" data-name="Heading 2">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Source_Sans_3:Bold',sans-serif] font-bold leading-[24px] left-0 text-[#101828] text-[20px] text-nowrap top-0">{`Projects  for 2023`}</p>
      </div>
    </div>
  );
}
...
function Component1() {
  return (
    <div className="bg-white h-[89px] relative shrink-0 w-full" data-name="2023">
...
function Heading2() {
  return (
    <div className="h-[24px] relative shrink-0 w-[138.406px]" data-name="Heading 2">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Source_Sans_3:Bold',sans-serif] font-bold leading-[24px] left-0 text-[#101828] text-[20px] text-nowrap top-0">{`Projects  for 2022`}</p>
      </div>
    </div>
  );
}
...
function Component() {
  return (
    <div className="bg-white h-[89px] relative shrink-0 w-full" data-name="2022">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none" />
      <div className="size-full">
        <div className="content-stretch flex flex-col items-start pb-px pt-[24px] px-[24px] relative size-full">
          <Container40 />
...
function ProjectManagement() {
  return (
    <div className="bg-white relative rounded-[10px] shrink-0 w-full" data-name="ProjectManagement">
...
export default function Module1ProjectsByYear() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="MODULE 1 - Projects by year">
      <Navbar />
      <BottomOfNav />
    </div>
  );

import svgPaths from "./svg-c41cfya30p";
...
function Slug() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="slug">
      <p className="font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#606060] text-[22px] text-nowrap">{`/  Expense Verification / Current Verifications`}</p>
    </div>
  );
}
...
function Frame() {
  return (
    <div className="content-stretch flex items-center pl-0 pr-[24px] py-0 relative shrink-0 w-[132px]">
      <div className="font-['Source_Sans_3:Regular',sans-serif] font-normal h-[40px] leading-[normal] mr-[-24px] relative shrink-0 text-[0px] text-black w-[132px]">
        <p className="mb-0 text-[14px]">Welcome Back,</p>
        <p className="text-[16px]">Administrative Aide</p>
      </div>
      <ChevronDown />
    </div>
  );
...
function Button4() {
  return (
    <div className="bg-[#3b5998] h-[36px] relative rounded-[10px] shrink-0 w-[161px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon7 />
        <p className="absolute font-['Source_Sans_3:Bold',sans-serif] font-bold leading-[20px] left-[90px] text-[14px] text-center text-nowrap text-white top-[8px] translate-x-[-50%]">Submit Verification</p>
      </div>
    </div>
  );
}
...
function Text1() {
  return (
    <div className="bg-[#fffbeb] h-[26px] relative rounded-[3.35544e+07px] shrink-0 w-[94px]" data-name="Text">
      ...
      <Text />
      <p className="absolute font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[16px] left-[29px] text-[#e17100] text-[12px] text-nowrap top-[4px]">Unverified</p>
    </div>
  );
}
...
function TableCell11() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start justify-center px-[20px] py-[17px] relative shrink-0 w-[154px]" data-name="Table Cell">
      <Container16 />
      <Text3 />
    </div>
  );
...
export default function ExpenseVerificationAdministrativeAideView() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Expense Verification -  (Administrative Aide View)">
      <Navbar />
      <BottomOfNav />
    </div>
  );

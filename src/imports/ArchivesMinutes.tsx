import svgPaths from "./svg-alv0uriyin";
...
function Slug() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="slug">
      <p className="font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#606060] text-[22px] text-nowrap">{`/  Archives / Minutes`}</p>
    </div>
  );
}
  ...
  return (
    <div className="basis-0 grow h-[24px] min-h-px min-w-px relative shrink-0" data-name="Heading 2">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[24px] left-0 text-[#101828] text-[16px] text-nowrap top-0">Minutes</p>
      </div>
    </div>
  );
}
...
function TableCell1() {
  return (
    <div className="absolute h-[88.5px] left-[131.94px] top-0 w-[210.922px]" data-name="Table Cell">
      <p className="absolute font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[24px] left-[24px] text-[#4a5565] text-[16px] text-nowrap top-[32.5px]">MTS-1271BPUI21</p>
    </div>
  );
}
...
function Text() {
  return (
    <div className="h-[24px] relative shrink-0 w-[330.75px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[24px] left-0 text-[#101828] text-[16px] text-nowrap top-0">TITLE</p>
      </div>
    </div>
  );
}
...
function TableCell7() {
  return (
    <div className="absolute h-[89px] left-[131.94px] top-0 w-[210.922px]" data-name="Table Cell">
      <p className="absolute font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[24px] left-[24px] text-[#4a5565] text-[16px] text-nowrap top-[32.5px]">MTS-1271ASR21</p>
    </div>
  );
}
...
function TableCell13() {
  return (
    <div className="absolute h-[89px] left-[131.94px] top-0 w-[210.922px]" data-name="Table Cell">
      <p className="absolute font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[24px] left-[24px] text-[#4a5565] text-[16px] text-nowrap top-[32.5px]">MTS-150271B21</p>
    </div>
  );
}
...
function TableCell19() {
  return (
    <div className="absolute h-[89px] left-[131.94px] top-0 w-[210.922px]" data-name="Table Cell">
      <p className="absolute font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[24px] left-[24px] text-[#4a5565] text-[16px] text-nowrap top-[32.5px]">MTS-1FF271A21</p>
    </div>
  );
}
...
function TableCell25() {
  return (
    <div className="absolute h-[89px] left-[131.94px] top-0 w-[210.922px]" data-name="Table Cell">
      <p className="absolute font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[24px] left-[24px] text-[#4a5565] text-[16px] text-nowrap top-[32.5px]">MTS-1SW271B21</p>
    </div>
  );
}
...
function TableCell31() {
  return (
    <div className="absolute h-[89px] left-[131.94px] top-0 w-[210.922px]" data-name="Table Cell">
      <p className="absolute font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[24px] left-[24px] text-[#4a5565] text-[16px] text-nowrap top-[32.5px]">MTS-12716ER1</p>
    </div>
  );
}
...
function TableCell37() {
  return (
    <div className="absolute h-[89px] left-[131.94px] top-0 w-[210.922px]" data-name="Table Cell">
      <p className="absolute font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[24px] left-[24px] text-[#4a5565] text-[16px] text-nowrap top-[32.5px]">MTS-1271VCR21</p>
    </div>
  );
}
...
function TableCell43() {
  return (
    <div className="absolute h-[89px] left-[131.94px] top-0 w-[210.922px]" data-name="Table Cell">
      <p className="absolute font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[24px] left-[24px] text-[#4a5565] text-[16px] text-nowrap top-[32.5px]">MTS-121071B21</p>
    </div>
  );
}
...
export default function ArchivesMinutes() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="ARCHIVES - Minutes">
      <Navbar />
      <BottomOfNav />
    </div>
  );

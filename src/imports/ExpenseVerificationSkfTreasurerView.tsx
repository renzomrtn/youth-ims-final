import svgPaths from "./svg-yhf1lco0wf";
...
export default function ExpenseVerificationSkfTreasurerView() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Expense Verification -  (SKF Treasurer View)">
      <Navbar />
      <BottomOfNav />
    </div>
  );

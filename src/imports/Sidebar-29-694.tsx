import svgPaths from "./svg-7vtnwhnxri";
...
export default function Sidebar() {
  return (
    <div className="bg-white relative rounded-br-[10px] size-full" data-name="sidebar">
      <div className="size-full">
        <div className="content-stretch flex flex-col gap-[54px] items-start overflow-clip px-[30px] py-[50px] relative size-full">
          <Dashboard />
          <Mains />
          <Utility />
          <Frame />

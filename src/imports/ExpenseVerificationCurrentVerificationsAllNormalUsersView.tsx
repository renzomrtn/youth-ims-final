import svgPaths from "./svg-zjktlfuqiq";
  ...
  return (
    <div className="content-stretch flex items-center pl-0 pr-[24px] py-0 relative shrink-0 w-[120px]">
      <div className="font-['Source_Sans_3:Regular',sans-serif] font-normal h-[40px] leading-[normal] mr-[-24px] relative shrink-0 text-[0px] text-black w-[120px]">
        ...
        <p className="text-[16px]">SKF Member</p>
      </div>
      <ChevronDown />
    </div>
  );
...
export default function ExpenseVerificationCurrentVerificationsAllNormalUsersView() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Expense Verification - Current Verifications (All Normal Users View)">
      <Navbar />
      <BottomOfNav />
    </div>
  );

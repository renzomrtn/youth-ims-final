import svgPaths from "./svg-yf31nq2iyq";
...
function BottomOfNav() {
  return (
    <div className="content-stretch flex h-[1037px] items-center relative shrink-0" data-name="bottom of nav">
      <Sidebar />
      <Content />
    </div>
  );
...
export default function ExpenseVerificationSkfAuditorView() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Expense Verification - (SKF Auditor View)">
      <Navbar />
      <BottomOfNav />
    </div>
  );

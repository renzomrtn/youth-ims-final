import svgPaths from "./svg-v1jd4nbltz";
...
function Slug() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="slug">
      <p className="font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#606060] text-[22px] text-nowrap">{`/  Portal Management / Verified Expenses`}</p>
    </div>
  );
}
  ...
  return (
    <div className="h-[24px] relative shrink-0 w-[68.922px]" data-name="Heading 2">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Source_Sans_3:Bold',sans-serif] font-bold leading-[24px] left-0 text-[#101828] text-[20px] text-nowrap top-0">Verified Expenses</p>
      </div>
    </div>
  );
}
    ...
    <div className="basis-0 bg-white grow h-[38px] min-h-px min-w-px relative rounded-[10px] shrink-0" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[12px] py-[8px] relative size-full">
          <p className="font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#6a7282] text-[14px] text-nowrap">Search Expenses...</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#d1d5dc] border-solid inset-0 pointer-events-none rounded-[10px]" />
    </div>
...
function ProjTit() {
  return (
    <div className="content-stretch flex h-[52px] items-start px-[24px] py-[16px] relative shrink-0 w-[510px]" data-name="proj tit">
...
function LiInfo() {
  return (
    <div className="content-stretch flex h-[52px] items-start px-[24px] py-[16px] relative shrink-0 w-[274px]" data-name="li info">
...
function Component1() {
  return (
    <div className="content-stretch flex h-[53px] items-start px-[24px] py-[16px] relative shrink-0 w-[250px]" data-name="4">
...
function Component2() {
  return (
    <div className="content-stretch flex h-[53px] items-center px-[24px] py-[16px] relative shrink-0 w-[182px]" data-name="7">
...
function Component3() {
  return (
    <div className="content-stretch flex h-[53px] items-center px-[24px] py-[16px] relative shrink-0 w-[160px]" data-name="9">
      <p className="basis-0 font-['Source_Sans_3:Bold',sans-serif] font-bold grow leading-[20px] min-h-px min-w-px relative shrink-0 text-[#364153] text-[14px]">Action</p>
    </div>
  );
}
...
function TableCell() {
  return (
    <div className="content-stretch flex items-center px-[24px] py-[36px] relative shrink-0 w-[510px]" data-name="Table Cell">
      <p className="font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#101828] text-[16px] text-nowrap">HIV/AIDS Awareness Seminar</p>
    </div>
  );
}
...
function TableCell1() {
  return (
    <div className="content-stretch flex flex-col items-start px-[24px] py-[28px] relative shrink-0 w-[274px]" data-name="Table Cell">
      <Container4 />
      <Container5 />
      <Container6 />
    </div>
...
function TableCell3() {
  return (
    <div className="content-stretch flex flex-col items-start px-[24px] py-[28px] relative shrink-0 w-[250px]" data-name="Table Cell">
      <Container7 />
      <Container8 />
    </div>
  );
...
function Text1() {
  return (
    <div className="bg-[#f0fdf4] h-[26px] relative rounded-[3.35544e+07px] shrink-0 w-[97.375px]" data-name="Text">
      ...
      <Text />
      <p className="absolute font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[16px] left-[29px] text-[#00a63e] text-[12px] text-nowrap top-[5px]">Published</p>
    </div>
  );
}
...
function TableCell4() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center px-[20px] py-[17px] relative shrink-0 w-[145px]" data-name="Table Cell">
      <Text1 />
    </div>
  );
}
...
function ToggleOn() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="toggle-on 1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g clipPath="url(#clip0_38_493)" id="toggle-on 1">
          <path d={svgPaths.p1fb8b300} fill="var(--fill-0, #00C950)" id="Vector" />
        </g>
        <defs>
...
function Container9() {
  return (
    <div className="absolute content-stretch flex h-[32px] items-center justify-end left-[24px] top-[28.25px] w-[68px]" data-name="Container">
      <ToggleOn />
    </div>
  );
}
...
function TableCell5() {
  return (
    <div className="h-[88.5px] relative shrink-0 w-[161.422px]" data-name="Table Cell">
      <Container9 />
    </div>
  );
}
...
function TableCell6() {
  return (
    <div className="content-stretch flex items-center px-[24px] py-[36px] relative shrink-0 w-[510px]" data-name="Table Cell">
      <p className="font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#101828] text-[16px] text-nowrap">Anti-Illegal Drugs Seminar</p>
    </div>
  );
}
...
function Container14() {
  return <div className="absolute h-[32px] left-[24px] top-[28.5px] w-[113.422px]" data-name="Container" />;
}
...
function TableCell18() {
  return (
    <div className="content-stretch flex items-center px-[24px] py-[36px] relative shrink-0 w-[510px]" data-name="Table Cell">
      <p className="font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#101828] text-[16px] text-nowrap">Environmental Cleanup Drive</p>
    </div>
  );
}
...
function TableCell24() {
  return (
    <div className="content-stretch flex items-center px-[24px] py-[35px] relative shrink-0 w-[510px]" data-name="Table Cell">
      <p className="font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#101828] text-[16px] text-nowrap">Youth Sports Festival</p>
    </div>
  );
}
...
function TableCell25() {
  return (
    <div className="content-stretch flex flex-col items-start px-[24px] py-[27px] relative shrink-0 w-[274px]" data-name="Table Cell">
      <Container28 />
      <Container29 />
      <p className="font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[#4a5565] text-[14px] w-full">
        <span className="font-['Source_Sans_3:Bold',sans-serif] font-bold">Budget:</span>
...
function TableCell27() {
  return (
    <div className="content-stretch flex flex-col items-start px-[24px] py-[27px] relative shrink-0 w-[250px]" data-name="Table Cell">
      <Container30 />
      <Container31 />
    </div>
  );
...
function LiquidationTable() {
  return (
    <div className="bg-white content-stretch flex flex-col h-[734px] items-start p-px relative rounded-[10px] shrink-0 w-[1566px]" data-name="LiquidationTable">
...
function Pagination() {
  return (
    <div className="content-stretch flex flex-col h-[93px] items-start pb-0 pt-[17px] px-[16px] relative shrink-0 w-[1566px]" data-name="Pagination">
...
function PortalManagement() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start justify-center p-px relative rounded-[10px] shrink-0" data-name="PortalManagement">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <LiquidationTable />
      <Pagination />
    </div>
...
function Content() {
  return (
    <div className="bg-[#f3f3f3] content-stretch flex flex-col gap-[20px] items-start overflow-clip p-[32px] relative rounded-tl-[24px] shrink-0 w-[1694px]" data-name="content">
      <Container />
      <PortalManagement />
    </div>
  );
...
export default function PortalManagementVerifiedExpenses() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="PORTAL MANAGEMENT - Verified Expenses">
      <Navbar />
      <BottomOfNav />
    </div>
  );

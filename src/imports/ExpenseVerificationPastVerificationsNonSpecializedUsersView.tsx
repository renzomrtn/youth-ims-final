import svgPaths from "./svg-65bn1x2q2c";
...
function Slug() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="slug">
      <p className="font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#606060] text-[22px] text-nowrap">{`/  Expense Verification / Past Verifications`}</p>
    </div>
  );
}
...
function Button2() {
  return (
    <div className="relative shrink-0" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center px-[3px] py-px relative">
        <p className="font-['Source_Sans_3:Bold',sans-serif] font-bold leading-[24px] relative shrink-0 text-[#155dfc] text-[16px] text-center text-nowrap">Past Verifications</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[24px] relative shrink-0 w-[68.922px]" data-name="Heading 2">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Source_Sans_3:Bold',sans-serif] font-bold leading-[24px] left-0 text-[#101828] text-[20px] text-nowrap top-0">Expense Verification</p>
      </div>
    </div>
  );
}
...
function ProjTit() {
  return (
    <div className="content-stretch flex h-[52px] items-start px-[24px] py-[16px] relative shrink-0 w-[333px]" data-name="proj tit">
...
function Component1() {
  return (
    <div className="content-stretch flex h-[53px] items-start px-[24px] py-[16px] relative shrink-0 w-[260px]" data-name="4">
...
function TableCell() {
  return (
    <div className="content-stretch flex items-center px-[24px] py-[36px] relative shrink-0 w-[333px]" data-name="Table Cell">
      <p className="font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#101828] text-[16px] text-nowrap">Community Health Check-Up</p>
    </div>
  );
}
...
function TableCell3() {
  return (
    <div className="content-stretch flex flex-col items-start px-[24px] py-[28px] relative shrink-0 w-[260px]" data-name="Table Cell">
      <Container7 />
      <Container8 />
    </div>
  );
...
function Container9() {
  return (
    <div className="content-stretch flex h-[20px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="basis-0 font-['Source_Sans_3:Regular',sans-serif] font-normal grow leading-[24px] min-h-px min-w-px relative shrink-0 text-[#101828] text-[16px]">Maria Garcia</p>
    </div>
  );
}
...
function TableCell6() {
  return (
    <div className="content-stretch flex items-center px-[24px] py-[36px] relative shrink-0 w-[333px]" data-name="Table Cell">
      <p className="font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#101828] text-[16px] w-[275px]">Fire Safety Awareness and Drill Program</p>
    </div>
  );
}
...
function TableCell12() {
  return (
    <div className="content-stretch flex items-center px-[24px] py-[36px] relative shrink-0 w-[333px]" data-name="Table Cell">
      <p className="font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#101828] text-[16px] text-nowrap">Training Program for Youth Athletes</p>
    </div>
  );
}
...
function TableCell18() {
  return (
    <div className="content-stretch flex items-center px-[24px] py-[35px] relative shrink-0 w-[333px]" data-name="Table Cell">
      <p className="font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[#101828] text-[16px] text-nowrap">Educational Assistance for Qualified Students</p>
    </div>
  );
}
...
function TableCell21() {
  return (
    <div className="content-stretch flex flex-col items-start px-[24px] py-[27px] relative shrink-0 w-[260px]" data-name="Table Cell">
      <Container22 />
      <Container23 />
    </div>
  );
...
function Table() {
  return (
    <div className="content-stretch flex flex-col gap-px h-[554px] items-start overflow-clip relative shrink-0 w-full" data-name="Table">
      <TableHeader />
      <TableBody />
    </div>
  );
...
function LiquidationTable() {
  return (
    <div className="bg-white h-[606px] relative rounded-tl-[10px] rounded-tr-[10px] shrink-0 w-full" data-name="LiquidationTable">
      <div aria-hidden="true" className="absolute border border-[#e5e7eb] border-solid inset-0 pointer-events-none rounded-tl-[10px] rounded-tr-[10px]" />
      <div className="size-full">
...
function Heading1() {
  return (
    <div className="h-[24px] relative shrink-0 w-[138.406px]" data-name="Heading 2">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Source_Sans_3:Bold',sans-serif] font-bold leading-[24px] left-0 text-[#101828] text-[20px] text-nowrap top-0">{`Verifications  for 2023`}</p>
      </div>
    </div>
  );
}
...
function Heading2() {
  return (
    <div className="h-[24px] relative shrink-0 w-[138.406px]" data-name="Heading 2">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Source_Sans_3:Bold',sans-serif] font-bold leading-[24px] left-0 text-[#101828] text-[20px] text-nowrap top-0">{`Verifications  for 2022`}</p>
      </div>
    </div>
  );
}
